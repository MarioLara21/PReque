    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonGC.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Intent i = new Intent(menu_administradores.this, GestionCubiculos.class);
                startActivity(i);
            }
        });
        buttonGU.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Intent i = new Intent(menu_administradores.this,Gestion_usuarios.class);
                startActivity(i);
            }
        });
        ...
        buttonGR.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Intent i = new Intent(menu_administradores.this, Gestion_Reservas.class);
                startActivity(i);
            }
        });
